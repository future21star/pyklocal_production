module Spree
	LineItem.class_eval do 
		...
		private
			...
			def notify_driver
				if (self.changes.include?(:delivery_state)) && (self.delivery_state == "packaging" || self.delivery_state == "ready_to_pick" || self.delivery_state == "out_for_delivery" || self.delivery_state == "confirmed_pickeup")
