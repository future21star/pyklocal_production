  ...
  before_action :before_address
	...
	def before_address
      ...
      if @order.try(:ship_address).present? && @order.try(:bill_address).present?
        p "(((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((999"
        p @order
        p @order.try(:ship_address).present?
        p  @order.try(:bill_address).present?
        ...
        @order.ship_address =  current_spree_user.bill_address
        @order.bill_address =  current_spree_user.ship_address
      else
        p "*********************************************************************************88"
