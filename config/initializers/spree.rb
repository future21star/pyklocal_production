...
Spree::PermittedAttributes.user_attributes.push :is_guest, :first_name, :last_name ,:mobile_number, stores_attributes: [:name, :certificate, :active, :payment_mode, :description, :manager_first_name, :manager_last_name, :phone_number, :store_type, :street_number, :city, :state, :zipcode, :country, :site_url, :terms_and_condition, :payment_information, :logo, spree_taxon_ids: [], store_users_attributes: [:spree_user_id, :store_id, :id]]
